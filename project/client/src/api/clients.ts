...
export const authApi = axios.create({
  baseURL: import.meta.env.VITE_AUTH_API_URL, // http://localhost:5017/api
  withCredentials: true, // для refresh-cookie
});

export const musicApi = axios.create({
  baseURL: import.meta.env.VITE_MUSIC_API_URL, // http://localhost:5191/api
